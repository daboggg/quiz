                ...
                <div class="row justify-content-between  align-items-center">
                  ...
                  <div class="col-5">
                    <div class="form-check form-check-inline">
                      <input v-model="quizMode" class="form-check-input" type="radio" name="inlineRadioOptions1"
                             :id="'inlineRadio1'+q.id"
                             value="exam">
                      <label class="form-check-label" :for="'inlineRadio1'+q.id">Режим экзамена</label>
                    </div>
                    <div class="form-check form-check-inline">
                      <input v-model="quizMode" class="form-check-input" type="radio" name="inlineRadioOptions1"
                             :id="'inlineRadio2'+q.id"
                             value="practice">
                  ...
                  <div class="col-5">
                    ...
                    <div class="form-check form-check-inline">
                      <input v-model="questionsInQuiz" class="form-check-input" type="radio" name="inlineRadioOptions2"
                             :id="'inlineRadio3'+q.id"
                             value="10">
                      <label class="form-check-label" :for="'inlineRadio3'+q.id">10</label>
                    </div>
                    <div class="form-check form-check-inline">
                      <input v-model="questionsInQuiz" class="form-check-input" type="radio" name="inlineRadioOptions2"
                             :id="'inlineRadio4'+q.id"
                             value="15">
                      <label class="form-check-label" :for="'inlineRadio4'+q.id">15</label>
                    </div>
                    <div class="form-check form-check-inline">
                      <input v-model="questionsInQuiz" class="form-check-input" type="radio" name="inlineRadioOptions2"
                             :id="'inlineRadio5'+q.id"
                             value="20">
